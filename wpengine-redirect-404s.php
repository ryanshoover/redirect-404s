<?php
/**
 * Plugin Name:     Redirect 404s
 * Description:     Did you change your permalink structure and now have old links "404ing"? I'll automatically redirect those old links to their new one for you.
 * Author:          Ryan Hoover
...
add_action( 'template_redirect', 'WPEngine\maybe_redirect_404_links' );
